...
def scrape_quotes(url):
    ...
    return quotes_list, author_page_url_list, next_page_url
...
def scrape_quotes_all_pages():
    ...
    while current_url:
        ...
        quotes, authors_urls, next_page_url = scrape_quotes(current_url)
        all_quotes.extend(quotes)
        for a_url in authors_urls:
            authors = scrape_authors(a_url)
